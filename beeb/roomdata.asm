...
EQUB PRT_XY+8,128,"GIV;:US:SOMETHi;:ELSE'",PRT_END
...
EQUB PRT_XY+24,72,"&owWTH:MATE<:I"
...
EQUB PRT_XY+14,104,"WORTH:SPv<:jwu:A"
...
EQUB PRT_XY+14,144,"ESCAPE:THRxGH:a"
EQUB PRT_XY+11,152,"FIw:USd:a:m'",PRT_END,PRT_END

.throwwateronfiremess
EQUB PRT_PEN+7,PRT_XY+2,48,PRT_DRAWBOX,21,6,PRT_PEN+3
EQUB PRT_XY+10,72, "b:THROW:a:JUG"
EQUB PRT_XY+10,80,"OF:m:qs:a"
...
EQUB PRT_XY+7,80,  "THiK:b;w:GOd@'",PRT_END
...
EQUB PRT_XY+8,80,"s:BwAK:UP:a:ROCK",PRT_END
...
EQUB PRT_PEN+7,PRT_XY+8,80,PRT_DRAWBOX,20,5,PRT_PEN+3
EQUB PRT_XY+14,104,"I:Dq;T:THiK:ju"
...
.roomname
EQUB ":a:BROKr:BRIDGE::", PRT_END

.rockinwatermess
EQUB PRT_PEN+7,PRT_XY+2,112,PRT_DRAWBOX,26,5,PRT_PEN+3
EQUB PRT_XY+6,136,"b:PUSH:a:ROCK:is:a"
EQUB PRT_XY+6,144,"RIVt:c:v:DISPLACES:a"
EQUB PRT_XY+8,152,"m<:RAISd:a:LEVEL",PRT_END
...
EQUB PRT_XY+10,80,"a:ROPE:ARxND"
...
.usecrowbarmess
EQUB PRT_PEN+7,PRT_XY+2,48,PRT_DRAWBOX,19,5,PRT_PEN+3
EQUB PRT_XY+8,72,"USd:a:CROWBAR"
...
.roomname
EQUB "a:LIFT:CqTROL:HUT", PRT_END
...
EQUB PRT_XY+8,144,"UNABLE:s:GROW",PRT_END
...
EQUB PRT_XY+8,88,"v:SLIPS:FROM:bR:HcS",PRT_END
...
EQUB PRT_XY+10,80,"BUCKET:WvH:m",PRT_END
...
EQUB PRT_XY+9,88,  "c:THxGHT:I;D:CjCK"
EQUB PRT_XY+15,96,  "xT:a:k'",PRT_END
...
EQUB PRT_XY+12,152, "a:WIZARDu:k'",PRT_END
...
EQUB PRT_XY+12,96,"e:jwu:bR:ROPE"
...
EQUB PRT_XY+13,120,"DRIVt;:e:WORTH:v"
EQUB PRT_END,PRT_END
...
EQUB PRT_XY+10,152, "&f<:v:WAS:NOTHd'",PRT_END
...
EQUB PRT_XY+15,128,"rJOYED:THIS:GAME",PRT_PEN+2
...
EQUB PRT_XY+11,80, "THy:DqE:WjN:b;w"
...
EQUB PRT_XY+8,88, "yYTHd:bR:OLD:GRc"
...
EQUB PRT_XY+9,120,"&WHAT@:f:THyKS:FOR"
EQUB PRT_XY+8,128,"OFFtd:s:jLP<:e:I"
EQUB PRT_XY+9,136,"THiK:b:SHxLD:oAY'",PRT_END

EQUB PRT_PEN+5,PRT_XY+4,64,PRT_DRAWBOX,24,6,PRT_PEN+6
EQUB PRT_XY+13,88, "&f<:IF:b:THiK"
...
EQUB PRT_XY+15,100,"m:c:DROWNED"
EQUB PRT_END
...
EQUB PRT_XY+17,88, "b:Aw:ROAoED"
EQUB PRT_XY+17,96, "BY:a:zau"
EQUB PRT_XY+20,104,"FItY:BwATH"
EQUB PRT_END
...
EQUB PRT_XY+8,96,"EVtYTHd:HAS"
EQUB PRT_XY+10,104,"DROPPED:xT@",PRT_END
