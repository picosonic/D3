...
.givingjunkmess  EQUB PRT_PEN+5,PRT_XY+2,96,PRT_DRAWBOX,25,4,PRT_PEN+6
...
.tencoinsmess  EQUB PRT_PEN+4,PRT_XY+10,120,PRT_DRAWBOX,22,4,PRT_PEN+3
  EQUB PRT_XY+18,144,"&WELL<:HOW;S:ABOUT"
  EQUB PRT_XY+15,152,"10:GOLD:COINS:FOR:IT'",PRT_END
.nottengoldcoins  EQUB PRT_PEN+5,PRT_XY+18,48,PRT_DRAWBOX,18,5,PRT_PEN+6
  EQUB PRT_XY+24,72,"&STREWTH:MATE<:I"
  EQUB PRT_XY+24,80,"SAID:INTERESTIN;"
  EQUB PRT_XY+27,88,"NOT:VALUABLE'",PRT_END
.fivecoinsmess  EQUB PRT_PEN+4,PRT_XY+2,104,PRT_DRAWBOX,15,4,PRT_PEN+3
  EQUB PRT_XY+11,128,"&WELL<:OK<"
  EQUB PRT_XY+8,136,"5:GOLD:COINS'",PRT_END
.notfivegoldcoins  EQUB PRT_PEN+5,PRT_XY+6,72,PRT_DRAWBOX,24,5,PRT_PEN+6
...
.erumbut  EQUB PRT_PEN+4,PRT_XY+16,112,PRT_DRAWBOX,10,4,PRT_PEN+3
  EQUB PRT_XY+22,136,"&ER<:UM<"
  EQUB PRT_XY+22,144,"BUT:>>>'",PRT_END
.throwsbean  EQUB PRT_PEN+5,PRT_XY+2,48,PRT_DRAWBOX,11,5,PRT_PEN+6
...
.pushdozymess  EQUB PRT_PEN+7,PRT_XY+6,72,PRT_DRAWBOX,22,6,PRT_PEN+3
...
.duffmem  EQUB 0
.dylantalking  EQUW duffmem ;;poked value,so must point somewhere
...
.trancemess  EQUB PRT_PEN+7,PRT_XY+4,80,PRT_DRAWBOX,24,4,PRT_PEN+3
  EQUB PRT_XY+14,104,"HOW:STRANGE<:DYLAN"
  EQUB PRT_XY+9,112,"SEEMS:TO:BE:IN:A:TRANCE",PRT_END
 
.denziltalking  EQUW ropehere+room
...
.stereoess  EQUB PRT_PEN+7,PRT_XY+8,80,PRT_DRAWBOX,19,5,PRT_PEN+3
...
.gottodaisymess  EQUB PRT_PEN+5,PRT_XY+2,48,PRT_DRAWBOX,17,5,PRT_PEN+6
...
.notgotallcoins  EQUB PRT_PEN+5,PRT_XY+2,48,PRT_DRAWBOX,21,6,PRT_PEN+6
...
.dougtalking  EQUW crowbarhere+room
...
.goonmysonmess  EQUB PRT_PEN+5,PRT_XY+2,48,PRT_DRAWBOX,21,5,PRT_PEN+6
...
.plantbeanmess  EQUB PRT_PEN+7,PRT_XY+6,48,PRT_DRAWBOX,22,5,PRT_PEN+3
...
.pickupmanuremess  EQUB PRT_PEN+7,PRT_XY+2,48,PRT_DRAWBOX,26,5,PRT_PEN+3
...
.throwswitchmess  EQUB PRT_PEN+7,PRT_XY+2,48,PRT_DRAWBOX,15,5,PRT_PEN+3
  EQUB PRT_XY+8,72,"YOU:THROW:THE"
  EQUB PRT_XY+8,80,"LEVER:TO:;ON;"
  EQUB PRT_XY+8,88,"BUT:IT:BREAKS",PRT_END

.fedarmorog  EQUB PRT_PEN+7,PRT_XY+2,48,PRT_DRAWBOX,18,4,PRT_PEN+3
  EQUB PRT_XY+8,72,"THAT:BONE:SHOULD"
  EQUB PRT_XY+10,80,"KEEP:HIM:BUSY@",PRT_END

.dragonasleepmess  EQUB PRT_PEN+7,PRT_XY+2,48,PRT_DRAWBOX,21,6,PRT_PEN+3
...
.croctiedmess  EQUB PRT_PEN+7,PRT_XY+2,48,PRT_DRAWBOX,19,5,PRT_PEN+3
  EQUB PRT_XY+11,72,"YOU:NIMBLY:TIE"
  EQUB PRT_XY+10,80,"THE:ROPE:AROUND"
  EQUB PRT_XY+8,88, "THE:GATOR;S:SNOUT",PRT_END

.rockinwatermess  EQUB PRT_PEN+7,PRT_XY+2,112,PRT_DRAWBOX,26,5,PRT_PEN+3
...
.fillbucketmess  EQUB PRT_PEN+7,PRT_XY+2,48,PRT_DRAWBOX,21,4,PRT_PEN+3
...
.goawaymess  EQUB PRT_PEN+5,PRT_XY+2,48,PRT_DRAWBOX,26,5,PRT_PEN+6
...
.usecrowbarmess  EQUB PRT_PEN+7,PRT_XY+2,48,PRT_DRAWBOX,19,5,PRT_PEN+3
...
.userugmess  EQUB PRT_PEN+7,PRT_XY+10,80,PRT_DRAWBOX,17,6,PRT_PEN+3
...
.dropwhiskeymess  EQUB PRT_PEN+2,PRT_XY+2,48,PRT_DRAWBOX,14,7,PRT_PEN+6
...
.holdingholemess  EQUB PRT_PEN+2,PRT_XY+2,48,PRT_DRAWBOX,16,7,PRT_PEN+6
...
.deadwindow  EQUB PRT_PEN+6,PRT_XY+10,64,PRT_DRAWBOX,18,6
...
.killedbyliftmess  EQUB PRT_XY+17,88,"YOU:GOT:TRAPPED"
  EQUB PRT_XY+18,96,"IN:THE:COGS:ON"
  EQUB PRT_XY+17,104,"TOP:OF:THE:LIFT"
  EQUB PRT_END

.dragonkilledmess  EQUB PRT_XY+16,88, "THE:DRAGON:BITES"
...
.killedbyflame  EQUB PRT_XY+18,88,"YOU:WERE:BURNT"
  EQUB PRT_XY+19,100,"BY:THE:FLAMES"
  EQUB PRT_END

.killedbywater  EQUB PRT_XY+17,88, "YOU:FELL:IN:THE"
  EQUB PRT_XY+15,100,"WATER:AND:DROWNED"
  EQUB PRT_END

.croceatenmess  EQUB PRT_XY+19,88,"THE:GATOR:HAS"
  EQUB PRT_XY+19,100,"YOU:FOR:LUNCH"
  EQUB PRT_END

.killedbyhawk  EQUB PRT_XY+18,88,"THE:DIZZY:HAWK"
  EQUB PRT_XY+21,96,"SWOOPS:DOWN"
  EQUB PRT_XY+19,104,"AND:KILLS:YOU"
  EQUB PRT_END

.ratgotyoumess  EQUB PRT_XY+20,88,"THE:RAT:GOES"
...
.inventory  EQUB PRT_PEN+4,PRT_XY+6,56,PRT_DRAWBOX,22,6,PRT_XY+16,76
.carrymess  EQUB PRT_PEN+5,"YOU:ARE:CARRYING",PRT_PEN+2,PRT_END
.inventorywithbag  EQUB PRT_PEN+4,PRT_XY+6,48,PRT_DRAWBOX,22,8,PRT_XY+16,68,PRT_GOSUB
  EQUW carrymess
  EQUB PRT_END

.selectitemmess  EQUB PRT_PEN+7,PRT_XY+14,136,PRT_DRAWBOX,14,2,PRT_PEN+5
...
.nothingatallmess  EQUB PRT_XY+22,96,PRT_PEN+7
